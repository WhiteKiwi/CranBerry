...
<body>
        ...
        <div>
			...
			<div style="margin-left: 50px; margin-right: 30px;">
				...
				<br />
				<br />
				<asp:Button ID="UploadButton" runat="server" style="height:39px;width:195px; background-color:#ff99ff; color:white; border-radius:15px; border-shadow:none; margin-right:40px; margin-bottom:50px;" CssClass="btn btn-primary float-right" OnClick="ApplyUpload" Text="등록"  /> 
