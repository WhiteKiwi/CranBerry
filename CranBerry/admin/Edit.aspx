<%@ Page Title="" Language="C#" MasterPageFile="~/master/Admin.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="CranBerry.admin.Edit" %>
	...
	<div style="width: 100%; height: 70%; padding-top: 50px; margin-bottom: 150px; padding-left: 100px; padding-right: 100px; text-align: left;">
		...
		<form runat="server" style="height: 100%;">
			...
			<div style="float: left; width: 70%; width: calc(100% - 300px); height: 70%;">
				...
				<!-- Contents -->
				<asp:TextBox ID="Contents" runat="server" TextMode="MultiLine" Width="100%" Height="100%" Rows="15" />
				<br />
